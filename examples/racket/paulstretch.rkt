...
;; via https://sccode.org/1-5d6#c1013
...
(define (paulstretchMono (out 0) bufnum envBufnum (pan 0) (stretch 50) (window 0.25) (amp 1))
  
  (let* (
         ;; Calculating fft buffer size according to suggested window size
        (fftSize (pow 2 (u:floor (u:log2 (* window sample-rate)))))
	...
	(trigPeriod  fftSize/SampleRate.ir)
        ...
        (po sDemand.ar(trig, 0, demandUGens: Dseries(0, trigPeriod/stretch)))
)))
